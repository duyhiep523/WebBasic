...
if (isset($_POST['btn_submit'])) {
    $usera = isset($_POST['user']) ? $_POST['user'] : "asdf";
    echo $usera;
    $passa = isset($_POST['pass']) ? $_POST['pass'] : "adsf";
    echo $passa;
    if (check_login($usera,  $passa)) {
        echo 'dang nhap thanh cong';
        $_SESSION['is_login'] = true;
        $_SESSION['user_login'] = $usera;
...
<body>
    <div class="container d-flex content justify-content-center align-items-center">
        <form action="" class="p-4" method="post">
            ...
            <br>
            <input type="submit" class="btn btn btn-primary " name="btn_submit" value="Login">
